<template>
  <section class="hero container has-ellipse-curve">
    <div class="hero-content">
      <h1 class="hero__headline">José Rodríguez </h1>
      <p class="hero__description">
        Ingeniero de software que crea cosas para la Web, muy centrado en el desarrollo front-end, entusiasta y fascinado
        con el diseño de la interfaz de usuario
      </p>
      <SocialMediaIcons />
    </div>
    <aside class="hero-aside">
      ...
      <HeroAvatar>
        <img src="@/assets/img/autor.jpg" alt="me" class="hero-avatar__image" width="140" height="140" loading="lazy" />
      </HeroAvatar>
    </aside>
  </section>
</template>
